<template>
    <div>
        ...
        <input type="search" class="filtro Normal input" placeholder="Pesquise pelo Título" v-model="filtro"/>
        <ul class="lista-fotos">
            <li v-for="foto in fotosComFiltro" class="lista-fotos-item">      
                    <meu-painel :titulo="foto.titulo">
                        ...
                        <meu-botao tipo="button" rotulo="Remover" :confirmacao="true" @botaoAtivado="removerFoto(foto, $event)" template="perigo"></meu-botao>
                    </meu-painel>                 
            </li>
        </ul>  
    </div>  
